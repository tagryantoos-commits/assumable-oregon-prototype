...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Highlands Ranch');
  ...
  const cityName = 'Highlands Ranch';
...
export default function HighlandsRanchPage() {
  const cityListings = getListingsByCity('Highlands Ranch');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Highlands Ranch, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Highlands Ranch with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">
            Highlands Ranch Has Some of the Best Assumable Inventory in Colorado
          </h2>
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Highlands Ranch is a master-planned community in Douglas County with some of Colorado&apos;s
              top-rated schools, world-class rec centers, and a highly desirable suburban lifestyle.
              Home prices range from $550,000 to $800,000 and higher. At {MARKET_RATE}%, those prices
              create payments that even dual-income households struggle to manage.
            </p>
            <p className="mt-3">
              Here&apos;s why Highlands Ranch is particularly rich in assumable inventory: the community has
              a large military presence from Peterson Space Force Base and Schriever Space Force Base
              commuters. VA loan origination volume during 2020–2022 was significant, and as those
              servicemembers rotate, VA-backed homes in Highlands Ranch come to market. Non-veterans
              can assume VA loans. You just need to qualify on income and credit.
            </p>
            <p className="mt-3">
              On a $500,000 remaining VA loan at 3.25%, principal and interest is $2,176/month. At
              {MARKET_RATE}%, it&apos;s $3,260/month. That&apos;s exactly $1,084/month in savings, $13,008
              per year. Highlands Ranch is worth buying in. Assumable mortgages make the payment realistic.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Highlands Ranch Deals</h2>
              <Link href="/homes?city=Highlands+Ranch" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            <Link
              href="/homes?city=Highlands+Ranch"
            ...
            >
              View All {cityListings.length} Highlands Ranch Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Highlands Ranch" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Highlands Ranch</h3>
            ...
            <div className="bg-white rounded-2xl p-6">
              <MarketExpertForm city="Highlands Ranch" />
            </div>
          </div>
        </div>
      </section>
