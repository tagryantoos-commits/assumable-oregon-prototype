...
import CastleRockExpertForm from '../../components/CastleRockExpertForm';
import { getRelatedPostsForCity } from '../../lib/blog';

export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Castle Rock');
...
export default function CastleRockPage() {
  const cityListings = getListingsByCity('Castle Rock');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Castle Rock, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Castle Rock with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Castle Rock has been one of Colorado&apos;s fastest-growing cities for a decade. Located in Douglas
              County between Denver and Colorado Springs, it attracts buyers who want newer construction,
              good schools, and space, without sacrificing commute access to either city. Median home prices
              regularly reach $600,000–$750,000. At {MARKET_RATE}%, ownership costs are serious.
            </p>
            <p className="mt-3">
              Castle Rock sits squarely in the Peterson Space Force Base and Schriever Space Force Base
              commuter zone. Many military personnel from Colorado Springs installations buy in Castle Rock
              or nearby Franktown. That creates VA loan inventory as those servicemembers rotate. Additionally,
              Castle Rock&apos;s 2020–2022 new construction surge was financed heavily with FHA and VA loans.
            </p>
            <p className="mt-3">
              On a $500,000 remaining VA loan at 3.25%, principal and interest is $2,176/month. At {MARKET_RATE}%,
              it&apos;s $3,260/month. That&apos;s $1,084 per month in savings, $13,008 per year. Castle Rock is
              worth owning. Assumable mortgages make it possible to own affordably.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Castle Rock Deals</h2>
              <Link href="/homes?city=Castle+Rock" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Castle Rock Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Castle Rock" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Castle Rock</h3>
