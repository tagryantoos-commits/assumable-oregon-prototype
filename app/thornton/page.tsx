...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Thornton');
...
export default function ThorntonPage() {
  const cityListings = getListingsByCity('Thornton');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Thornton, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Thornton with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Thornton is one of Denver&apos;s fastest-growing suburbs, attracting buyers who want more space
              and more value north of the city. The I-25 corridor runs right through, connecting Thornton
              to downtown Denver, and new development has kept pace with demand. Median home prices
              in Thornton run $450,000–$550,000, accessible compared to Denver proper, but still painful
              at {MARKET_RATE}% interest rates.
            </p>
            <p className="mt-3">
              Thornton absorbed significant FHA purchase volume in 2020–2021. The northern suburbs attracted
              first-time buyers and families looking for newer construction at more reasonable price points.
              Those FHA loans are fully assumable today, no military service required, just standard
              credit and income qualification.
            </p>
            <p className="mt-3">
              On a $380,000 remaining FHA loan at 2.875%, your payment is $1,575/month. At {MARKET_RATE}%,
              it&apos;s $2,530/month. That&apos;s $955 per month, $11,460 per year, that stays with you.
              In Thornton&apos;s market, that kind of payment advantage helps you compete, save, and build
              wealth faster.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Thornton Deals</h2>
              <Link href="/homes?city=Thornton" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Thornton Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Thornton" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Thornton</h3>
            ...
            <div className="bg-white rounded-2xl p-6">
              <MarketExpertForm city="Thornton" />
            </div>
          </div>
        </div>
      </section>
