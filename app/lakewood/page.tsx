...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Lakewood');
...
export default function LakewoodPage() {
  const cityListings = getListingsByCity('Lakewood');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Lakewood, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Lakewood with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Lakewood is one of Denver&apos;s most desirable western suburbs, quick access to the mountains,
              Red Rocks, and downtown Denver, with a strong mix of neighborhoods from Belmar to Green Mountain.
              Home prices regularly hit $500,000–$650,000, and at {MARKET_RATE}%, affordability is a real
              obstacle for buyers.
            </p>
            <p className="mt-3">
              The Denver Federal Center is located in Lakewood, and federal employees (many of whom used
              FHA loans in 2020–2021) represent a meaningful source of assumable loan inventory. Add the
              standard FHA first-time buyer wave from those years, and Lakewood has real inventory to work with.
            </p>
            <p className="mt-3">
              On a $420,000 remaining FHA or VA loan at 3.0%, your principal and interest is $1,771/month.
              At {MARKET_RATE}%, the same balance costs $2,795/month. That&apos;s $1,024 per month in your pocket
              instead of the bank&apos;s. Lakewood homes appreciate. You want to own one. Assumable mortgages
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Lakewood Deals</h2>
              <Link href="/homes?city=Lakewood" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Lakewood Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Lakewood" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Lakewood</h3>
            ...
            <div className="bg-white rounded-2xl p-6">
              <MarketExpertForm city="Lakewood" />
            </div>
          </div>
        </div>
      </section>
