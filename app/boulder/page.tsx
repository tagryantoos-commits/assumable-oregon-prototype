...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Boulder');
...
export default function BoulderPage() {
  const cityListings = getListingsByCity('Boulder');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Boulder, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Boulder with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Boulder has some of the highest home prices in Colorado, with median values routinely exceeding
              $800,000. CU Boulder, the tech and startup ecosystem, and strong outdoor culture drive relentless
              demand. At {MARKET_RATE}%, buying a $750,000 home requires a payment that most high earners still
              find uncomfortable.
            </p>
            <p className="mt-3">
              Assumable mortgages flip that equation. Boulder&apos;s 2020–2022 FHA and VA purchase volume. When
              buyers locked in at 2.75–3.5%, creating a pool of below-market-rate loans attached to homes
              that have appreciated significantly since. The rate spread is enormous, and so are the monthly
              savings.
            </p>
            <p className="mt-3">
              On a $500,000 remaining loan balance, 3.25% means $2,176/month. At {MARKET_RATE}%, that same
              balance costs $3,260/month. You&apos;re saving $1,084 every month, $13,008 per year. In Boulder,
              that&apos;s not a rounding error. That&apos;s a real lifestyle difference.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Boulder Deals</h2>
              <Link href="/homes?city=Boulder" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Boulder Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Boulder" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Boulder</h3>
