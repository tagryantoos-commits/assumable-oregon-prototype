...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Arvada');
...
export default function ArvadaPage() {
  const cityListings = getListingsByCity('Arvada');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Arvada, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Arvada with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Arvada has grown into one of the Denver metro&apos;s most popular suburbs. Walkable Olde Town,
              light rail access, strong schools, and a tight community feel. Home prices have climbed
              accordingly, regularly hitting $550,000–$700,000 for a solid single-family home.
              At {MARKET_RATE}%, the monthly cost of ownership is steep.
            </p>
            <p className="mt-3">
              The good news: Arvada saw strong FHA and VA purchase activity during 2020–2022. Those loans,
              originated at historic low rates, are now attached to homes that have appreciated significantly.
              The equity gap requires planning, but the monthly payment advantage is substantial.
            </p>
            <p className="mt-3">
              On a $450,000 remaining balance at 3.0%, principal and interest is $1,897/month. At {MARKET_RATE}%,
              it&apos;s $2,995/month. Save $1,098/month ($13,176/year). That&apos;s what finding the right assumable
              listing in Arvada is worth.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Arvada Deals</h2>
              <Link href="/homes?city=Arvada" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Arvada Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Arvada" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Arvada</h3>
