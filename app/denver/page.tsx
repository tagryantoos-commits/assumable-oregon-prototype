...
export function generateMetadata(): Metadata {
  const cityListings_meta = getListingsByCity('Denver');
  const count = cityListings_meta.length;
  const minRate = count > 0 ? Math.min(...cityListings_meta.map(l => l.assumableRate)).toFixed(2) : '2.25';
  const slug = 'denver';
...
export default function DenverPage() {
  const cityListings = getListingsByCity('Denver');
  ...
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'Assumable Mortgage Listings in Denver, CO',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-6">
              {cityListings.length} active listings in Denver with assumable mortgages.
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 text-sm leading-relaxed mb-8">
            <p>
              Denver&apos;s competitive housing market has made assumable mortgages increasingly valuable.
              With home prices climbing and interest rates elevated, locking in a 2-4% assumable rate
              can translate to hundreds of dollars in monthly savings.
            </p>
            <p className="mt-3">
              The Denver metro area has experienced significant population growth, with families and
              professionals relocating to Colorado for career opportunities and quality of life. This
              high demand has intensified the need for creative financing solutions like assumption.
              With {cityListings.length} active assumable listings in the Denver metro, there&apos;s
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-2xl font-bold text-gray-900">Top Denver Deals</h2>
              <Link href="/homes?city=Denver" className="text-brand hover:text-brand-dark text-sm font-semibold">
          ...
          <div className="text-center mb-12">
            ...
            >
              View All {cityListings.length} Denver Listings →
            </Link>
          </div>

          {/* Related Blog Posts */}
          <RelatedBlogPosts cityName="Denver" />

          {/* Lead form */}
          <div id="get-notified" className="bg-gradient-to-br from-gray-900 to-brand-dark rounded-3xl p-8 text-white">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-2">Talk to an Assumable Mortgage Expert in Denver</h3>
