    ...
    try {
      await fetch('/api/leads', {
        ...
        body: JSON.stringify({
          ...formData,
          type: 'agent',
          source: 'ai-for-agents',
          formType: 'Form: AI Course Waitlist',
          timestamp: new Date().toISOString(),
        }),
      });
      if (typeof window !== 'undefined' && (window as any).fbq) {
        (window as any).fbq('trackCustom', 'AIWaitlist');
      }
      setSubmitted(true);
    } catch {
      setSubmitted(true);
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-2">
          We&apos;ll send you the details as soon as enrollment opens.
        </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
      ...
      <p className="text-xs text-center text-gray-400">
        Free to join. No spam. We&apos;ll notify you when the course drops.
      </p>
    </form>
  );
}
